...
if __name__ == '__main__':
    ...
    # fig.tight_layout()
    fig.legend(all_handles, all_labels, loc='upper center', bbox_to_anchor=(0.5, 1.01), ncol=3, fontsize=13, frameon=False, columnspacing=0.8)


    
    plt.savefig(os.path.join(save_file_dir, 'save_figs', 'figure_2a-k_allinonebar_w_slivit.pdf'), dpi=300)
    plt.savefig(os.path.join(save_file_dir, 'save_figs', 'figure_2a-k_allinonebar_w_slivit.png'))
    import time 
    # time.sleep(10)
