...
if __name__ == '__main__':
    ...
    AIREADI_oph_tasks_barplot(fig, axes[1, :], grouped_dict, setting_code='default', plot_col='auprc', plot_tasks=[], plot_methods= [('MAE-joint', '3D'), ('retfound', '3D'), ('MAE2D', '3D'), ('retfound', '2D')], y_name='AUPRC')
    # plot the subfigure f-j
    all_handles, all_labels = AIREADI_oph_tasks_barplot(fig, axes[0, :], grouped_dict, setting_code='default', plot_col='auroc', plot_tasks=[], plot_methods=[('MAE-joint', '3D'), ('retfound', '3D'), ('MAE2D', '3D'), ('retfound', '2D')], y_name='AUROC')
