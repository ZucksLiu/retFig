...
GA_prog_BCVA_mean_res = os.path.join(save_file_dir, 'GA_prog/plot_GA_prog_BCVA_mean.csv')
GA_prog_BCVA_mean_res_df = pd.read_csv(GA_prog_BCVA_mean_res)
GA_prog_GAGrowth_mean_res = os.path.join(save_file_dir, 'GA_prog/plot_GA_prog_GAGrowth_mean.csv')
GA_prog_GAGrowth_mean_res_df = pd.read_csv(GA_prog_GAGrowth_mean_res)

GA_prog_BCVA_std_res = os.path.join(save_file_dir, 'GA_prog/plot_GA_prog_BCVA_std.csv')
GA_prog_BCVA_std_res_df = pd.read_csv(GA_prog_BCVA_std_res)
GA_prog_GAGrowth_std_res = os.path.join(save_file_dir, 'GA_prog/plot_GA_prog_GAGrowth_std.csv')
