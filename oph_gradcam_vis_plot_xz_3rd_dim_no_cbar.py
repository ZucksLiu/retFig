...
for i in range(num_frames):
    ...
    axs[0, i].set_title(f'Slice {cam_2_image_index[i]}', fontsize=18)#, dim (x, z)')
...
fig.add_artist(line)
# fig.tight_layout()
plt.savefig(save_dir + 'gradcam_vis_plot_xz_3rd_nocbar.jpg')
plt.savefig(save_dir + 'gradcam_vis_plot_xz_3rd_nocbar.pdf', format='pdf', dpi=300)
