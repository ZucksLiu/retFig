...
for i in image_index:
    ...
    gradcam_3d_img_path = test_cam_3d_dir + f'/test_cam_{i-1}.jpg'
    gradcam_3d_img.append(cv2.imread(gradcam_3d_img_path))


# plot
fig, axs = plt.subplots(4, num_frames, figsize=(13, 10))
...
for i in range(num_frames):
    ...
    if i == 3:
        rect = patches.Rectangle((100, 100), 40, 40, linewidth=3, edgecolor='r', facecolor='none')
...
fig.add_artist(line)
# fig.tight_layout()
plt.savefig(save_dir + f'gradcam_vis_plot_xz_nocbar_supp_fig1_{test_cam_id}.jpg')
plt.savefig(save_dir + f'gradcam_vis_plot_xz_nocbar_supp_fig1_{test_cam_id}.pdf', format='pdf', dpi=300)
