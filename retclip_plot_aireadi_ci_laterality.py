...
def plot_retclip_exp_res(retclip_exp_res_df):
    ...
    plt.savefig(os.path.join(save_file_dir, 'save_figs', 'retClip_exp_res_aireadi_laterality_ci.png'))
    plt.savefig(os.path.join(save_file_dir, 'save_figs', 'retClip_exp_res_aireadi_laterality_ci.pdf'), dpi=300)
