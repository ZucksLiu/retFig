...
def plot_retclip_exp_res(fig, ax, retclip_exp_res_df):
    ...
    col_names = ['Precision@1', 'Precision@5']#  'Precision@3', , 'Precision@10']

    all_handles, all_labels = plot_retclip_recall_and_mean_rank(ax[:2], retclip_exp_res_df, first_row_prefix, col_names)
    plot_retclip_recall_and_mean_rank(ax[2:4], retclip_exp_res_df, second_row_prefix, col_names, print_xlabels=True)
...
fig, axes = plt.subplots(figsize=(1.8*FIG_WIDTH, 0.3*FIG_HEIGHT), nrows=1, ncols=8) 
...
def plot_retclip_exp_res(fig, ax, retclip_exp_res_df):
    ...
    second_row_prefix = 'IR_to_OCT'
    # col_names = ['recall@1', 'recall@5', 'recall@10', 'mean rank']
    col_names = ['Precision@1', 'Precision@5'] #, 'Precision@5', 'Precision@10']
    all_handles, all_labels = plot_retclip_recall_and_mean_rank(ax[4:6], retclip_exp_res_df, first_row_prefix, col_names)
    plot_retclip_recall_and_mean_rank(ax[6:], retclip_exp_res_df, second_row_prefix, col_names, print_xlabels=True)
...
plt.savefig(os.path.join(save_file_dir, 'save_figs', 'retClip_exp_res_laterality_ci_together_onerow.png'))
plt.savefig(os.path.join(save_file_dir, 'save_figs', 'retClip_exp_res_laterality_ci_together_onerow.pdf'), dpi=300)
