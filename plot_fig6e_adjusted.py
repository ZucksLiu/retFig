...
sham = [0, 0.5, 1.5, 3]
low_dose = [0, 0.4, 1.4, 2.8]
high_dose = [0, 0.6, 1.8, 3.4]
error = [0.1, 0.2, 0.2, 0.3]  # Example error bars
...
ax[0].errorbar(months, sham, yerr=error, label='Sham', marker='o', linestyle='-', capsize=3, color=sham_color)
ax[0].errorbar(months, low_dose, yerr=error, label='Low dose', marker='o', linestyle='-', capsize=3, color=low_dose_color)
ax[0].errorbar(months, high_dose, yerr=error, label='High dose', marker='o', linestyle='-', capsize=3, color=high_dose_color)
...
sham_adjusted = [0, 0.5, 1.5, 2.9]  # Replace with actual adjusted data
low_dose_adjusted = [0, 0.4, 1.3, 2.7]
high_dose_adjusted = [0, 0.6, 1.7, 3.1]

ax[1].errorbar(months, sham_adjusted, yerr=error, label='Sham', marker='o', linestyle='-', capsize=3, color=sham_color)
ax[1].errorbar(months, low_dose_adjusted, yerr=error, label='Low dose', marker='o', linestyle='-', capsize=3, color=low_dose_color)
ax[1].errorbar(months, high_dose_adjusted, yerr=error, label='High dose', marker='o', linestyle='-', capsize=3, color=high_dose_color)
