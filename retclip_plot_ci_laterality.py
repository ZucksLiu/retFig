...
retclip_laterality_dir = home_directory + 'retclip_eval_multitask_laterality/'
octcube_df = pd.read_csv(retclip_laterality_dir + 'MAE3D_nodrop_all_laterality.csv')
octcube_ir_df = pd.read_csv(retclip_laterality_dir + 'MAE3D_nodrop_all_laterality_ir.csv')
retfound_3d_df = pd.read_csv(retclip_laterality_dir + 'retFound3D_all_laterality.csv')
retfound_2d_df = pd.read_csv(retclip_laterality_dir + 'retFound2D_all_laterality.csv')
retfound_3d_ir_df = pd.read_csv(retclip_laterality_dir + 'retFound3D_all_laterality_ir.csv')
retfound_2d_ir_df = pd.read_csv(retclip_laterality_dir + 'retFound2D_all_laterality_ir.csv')
print(octcube_df)
# exit()
...
print(retclip_exp_res_df)
print(retclip_exp_res_df.index) 
# exit()
...
def plot_retclip_recall_and_mean_rank(axes, retclip_exp_res_df, prefix, col_names, reverse_plot=False, err_bar=True):
...
def plot_retclip_exp_res(retclip_exp_res_df):
    ...
    plt.savefig(os.path.join(save_file_dir, 'save_figs', 'retClip_exp_res_laterality_ci.png'))
    plt.savefig(os.path.join(save_file_dir, 'save_figs', 'retClip_exp_res_laterality_ci.pdf'), dpi=300)
