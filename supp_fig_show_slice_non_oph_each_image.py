...
num_frames = 1
# plot
fig, axs = plt.subplots(2, num_frames, figsize=(20/3, 9))
if patient_idx == 8490:
    for i in range(2):
...
plt.tight_layout()
plt.savefig(save_dir + f'diabete_show_slice_{patient_idx}_oneimage.png')
plt.savefig(save_dir + f'diabete_show_slice_{patient_idx}_oneimage.pdf', dpi=300)
plt.show()